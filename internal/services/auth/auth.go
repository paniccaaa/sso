...
import (
	...
	"github.com/paniccaaa/sso/internal/domain/models"
	"github.com/paniccaaa/sso/internal/lib/jwt"
...
type UserSaver interface {
	SaveUser(ctx context.Context, passHash []byte, email, role string) (uid int64, err error)
}
...
func (a *Auth) RegisterNewUser(ctx context.Context, email string, pass, role string) (int64, error) {
	...
	id, err := a.usrSaver.SaveUser(ctx, passHash, email, role)
	if err != nil {
